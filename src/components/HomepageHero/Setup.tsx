      ...
      <div className={styles.content}>
        ...
        <Link
          ...
          dangerouslySetInnerHTML={{
            __html: t('featureSupport', {
              feature: `AI Chat, Translation, Code Editor`,
            }),
          }}
        />
        ...
        <div className="flex justify-center pt-10">
          <div className="max-w-[500px] flex flex-wrap gap-[20px] max-sm:justify-center">
            ...
            >
              <Link
                href={`/zh/modernCpp/01_%E7%AC%AC1%E7%AB%A0_%E6%96%B0%E5%9F%BA%E7%A1%80%E7%B1%BB%E5%9E%8B/1.1_%E6%95%B4%E6%95%B0%E7%B1%BB%E5%9E%8Blong_long`}
              >
                {t('getStarted')}
